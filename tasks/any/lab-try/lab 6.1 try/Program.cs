...
namespace lab_6._1_try
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                string inFilePath = $"/home/alexandr/progbase/progbase/tasks/any/lab 6.1 try/{options.inputFile}";
                var isExistInFile = File.Exists(inFilePath);
                string outFilePath = $"/home/alexandr/progbase/progbase/tasks/any/lab 6.1 try/{options.inputFile}";
